...
const MENU_SECTIONS = [
  ...
  { key: "alunosCadastro",  label: "Alunos",             sub: "Cadastro pessoal dos alunos",   Icon: Users,             locked: false },
...
export const ATALHOS_MAP = [
  ...
  { code: "KeyL", display: "Alt + L", key: "alunosCadastro",  hint: "aLunos (cadastro)"   },
