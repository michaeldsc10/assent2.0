  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        letterSpacing: ".08em", color: "var(--text-3, #aaa)",
      }}>
        {Icon && <Icon size={11} strokeWidth={2.5} />}
        {label}
      </div>
      <div style={{
        fontSize: 13.5, color: "var(--text-1, #f0f0f0)",
      ...
      <div className="modal-box modal-box-lg" style={{ overflow: "hidden", padding: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{
              display: "flex", alignItems: "center", gap: 6,
              fontSize: 12.5, color: "var(--text-3, #aaa)",
            }}>
        ...
        <div style={{
          ...
          {evento.dataCriacao && (
            <DetalheCard
              ...
              fullWidth
              valueStyle={{ color: "var(--text-3, #aaa)", fontSize: 12, fontWeight: 400 }}
            />
          )}
        </div>
