...
const CSS = `
  ...
  .vd-th-sort:hover { color: var(--text-2); }
  .vd-th-sort.active { color: var(--gold); }
  ...
  const vendasFiltradas = useMemo(() => {
    ...
    lista = [...lista].sort((a, b) => {
      ...
      if (sortKey === "cliente") {
        ...
        va = (a.itens?.[0]?.nome || "").toLowerCase();
        vb = (b.itens?.[0]?.nome || "").toLowerCase();
        ...
        <div className="ag-content">
          <div className="vd-table-wrap">
            ...
            <div className="vd-row vd-row-head">
              ...
              <span>
                <span className={`vd-th-sort ${sortKey === "data" ? "active" : ""}`} onClick={() => handleSort("data")}>
              ...
              <span>VENDEDOR</span>
              <span>
                <span className={`vd-th-sort ${sortKey === "produto" ? "active" : ""}`} onClick={() => handleSort("produto")}>
                  ITENS <SortIcon col="produto" />
                </span>
              </span>
              <span>
                <span className={`vd-th-sort ${sortKey === "total" ? "active" : ""}`} onClick={() => handleSort("total")}>
